...
public class RBooleanClause implements java.io.Serializable {
  ...
  */ 
  public RBooleanClause(RQuery query, Occur occur) {
    this.query = query;
    this.occur = occur;
  }
  ...
  public void setQuery(RQuery query) {
    this.query = query;
  }
  ...
  public boolean equals(Object o) {
    if (!(o instanceof RBooleanClause))
      return false;
    RBooleanClause other = (RBooleanClause)o;
