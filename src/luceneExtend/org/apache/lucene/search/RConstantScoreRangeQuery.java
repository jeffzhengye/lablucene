...
public class RConstantScoreRangeQuery extends RQuery
{
  ...
  public RConstantScoreRangeQuery(String fieldName, String lowerVal, String upperVal, boolean includeLower, boolean includeUpper)
  {
  ...
  public RConstantScoreRangeQuery(String fieldName, String lowerVal,
  ...
  public RQuery rewrite(IndexReader reader) throws IOException {
    ...
    RangeFilter rangeFilt = new RangeFilter
        (fieldName, lowerVal != null?lowerVal:"", upperVal,
         ...
         collator);
    RQuery q = new RConstantScoreQuery(rangeFilt);
    q.setBoost(getBoost());
    return q;
  }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof RConstantScoreRangeQuery)) return false;
        RConstantScoreRangeQuery other = (RConstantScoreRangeQuery) o;
