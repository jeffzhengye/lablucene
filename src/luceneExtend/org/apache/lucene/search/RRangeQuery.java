 ...
 */
public class RRangeQuery extends RQuery
{
     ...
     */
    public RRangeQuery(Term lowerTerm, Term upperTerm, boolean inclusive)
    {
    ...
    public RQuery rewrite(IndexReader reader) throws IOException {
        ...
        RBooleanQuery query = new RBooleanQuery(true);
    ...
    private void addTermToQuery(Term term, RBooleanQuery query) {
        RTermQuery tq = new RTermQuery(term);
        tq.setBoost(getBoost()); // set the boost
        query.add(tq, RBooleanClause.Occur.SHOULD); // add to query
    }
    ...
    public boolean equals(Object o) {
        ...
        final RRangeQuery other = (RRangeQuery) o;
