...
public class TFMIDF extends WeightingModel {
	...
	static float lambda = Float.parseFloat(ApplicationSetup.getProperty("tfmidf.lambda", "0.9"));
...
//	    logger.info("" + TFF + ":" + IDF/(1+IDF));
	    return keyFrequency * (lambda*TFF + (1-lambda)*IDF/(1+IDF));
	}
