 ...
 *
 *
 * @version $Id: ConstantScoreQuery.java 697119 2008-09-19 14:52:37Z mikemccand $
 */
public class RConstantScoreQuery extends RQuery {
  protected final Filter filter;

  public RConstantScoreQuery(Filter filter) {
    this.filter=filter;
  }
  ...
  protected class ConstantWeight implements Weight {
    ...
    public Query getQuery() {
      return RConstantScoreQuery.this;
    }
  ...
  protected class ConstantScorer extends RScorer {
	...
	@Override
	public float score(int currentDoc) throws IOException {
		return theScore;
	}
  }
  ...
  protected Weight createWeight(Searcher searcher) {
    return new RConstantScoreQuery.ConstantWeight(searcher);
  }
