...
public class NamedPageEvaluation extends Evaluation {
	...
	public void evaluate(String resultFilename) {
		...
		int previousQueryId = -1;
			...
			String lines[] = org.dutir.util.Files.readLinesFromFile(new File(resultFilename), ApplicationSetup.getProperty("file.encoding", "utf8"));
	...
	public void writeEvaluationResultOfEachQuery(PrintWriter out) {
		...
		try {
			...
			logger.error("Couldn't write evaluation file "+out.toString(), fnfe);
		}
