 ...
 * 
 * <p>
 * A <code>Scorer</code> either iterates over documents matching a query in
 * increasing order of doc Id, or provides an explanation of the score for a
 * query for a given document.
 * </p>
 * <p>
...
public abstract class Scorer extends DocIdSetIterator {
	 ...
	 * 
	 * @param similarity
	 *            The <code>Similarity</code> implementation used by this
	 *            scorer.
	 */
	 ...
	 * invalid, until {@link #next()} or {@link #skipTo(int)} is called the
	 * first time.
	 */
...
//	public abstract float getLogAlphaD(int currentDoc) throws IOException;
