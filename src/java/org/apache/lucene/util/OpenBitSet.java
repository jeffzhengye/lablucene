...
public class OpenBitSet extends DocIdSet implements Cloneable, Serializable {
  ...
  */
  ...
  /**
   * An OpenBitSet with 10M size will use 12.5M memory 
   * @param args
   */
  public static void main(String args[]) {
		...
		OpenBitSet set = new OpenBitSet(1024 * 1024 * 1000);

		long total_e = Runtime.getRuntime().totalMemory();
		long free_e = Runtime.getRuntime().freeMemory();
		System.out.println(total / M + ",\t" + free / M);
		System.out.println(total_e / M + ",\t" + free_e / M);
	}
