 ...
 *
 * @version $Id: TestMultiSearcher.java 694004 2008-09-10 21:38:52Z mikemccand $
 */
public class TestMultiSearcher extends LuceneTestCase
{
        ...
        throws Exception
    {
        ...
        Term term = new Term("fulltext", "Once");
        int dfreq = mSearcher.docFreq(term);
        int freq = mSearcher.termFreq(term);
        System.err.println("freq:" + freq + ", dfreq: " + dfreq);
        ...
        Term termx = new Term("id", "doc1");
        IndexReader readerB = IndexReader.open(indexStoreB);
        readerB.deleteDocuments(termx);
        readerB.close();
