...
REM -- Run TRECTerrier
REM ------------------------
rem echo java -Xmx512M -Dterrier.home="%TERRIER_HOME%" -Dterrier.etc="%TERRIER_ETC%" -Dterrier.setup="%TERRIER_ETC%\terrier.properties" -cp %LOCALCLASSPATH% %JAVA_OPTIONS% %TERRIER_OPTIONS% TrecTerrier %*


java -Xmx512M -Dterrier.home="%TERRIER_HOME%" -Dterrier.etc="%TERRIER_ETC%" -Dterrier.setup="%TERRIER_ETC%\terrier.properties" -cp %LOCALCLASSPATH% %JAVA_OPTIONS% %TERRIER_OPTIONS% TrecTerrier %*
